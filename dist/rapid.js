 ...
 */
function createTexture(gl, source, antialias, withSize = false, flipY = false) {
...
class SpriteRegion extends RenderRegion {
    ...
    renderSprite(texture, width, height, u0, v0, u1, v1, offsetX, offsetY, color, uniforms, flipX, flipY) {
        // let rendered = false
...
export { ArrayType, BaseTexture, Color, DynamicArrayBuffer, FrameBufferObject, GLShader, MaskType, MathUtils, MatrixStack, Rapid, SCALEFACTOR, ShaderType, Text, Texture, TextureCache, TileMapRender, TileSet, TilemapShape, Uniform, Vec2, WebglBufferArray, WebglElementBufferArray, graphicAttributes, spriteAttributes };
